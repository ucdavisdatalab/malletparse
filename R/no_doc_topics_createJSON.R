...
#' @param topic.frequency A numeric vector of the topic frequencies can be calculated with rcpp_parse_doc_topics.
...
#'
#' @export
no_doc_topics_createJSON <- function(phi = matrix(), topic.frequency,
                       ...
                       ...) 
{
  ...
  K <- dp[1]  # number of topics in the model -- use phi because always supplied
